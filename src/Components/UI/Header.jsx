          ...
          <div className="d-flex align-items-center justify-content-between">
            <div className="d-none d-xl-block">
              <div className="languageDropdown d-flex align-items-center">
                <div className="common_dropdown dropdown">
                  <button type="button" id="dropdown-basic" aria-expanded="false" className="dropdown-toggle btn">
                  ...
                  <div aria-labelledby="dropdown-basic" data-bs-popper="static" className="dropdown-menu">
                    <a data-rr-ui-dropdown-item="" className="dropdown-item" role="button" tabIndex="0" href="#">English</a>
                    <a data-rr-ui-dropdown-item="" className="dropdown-item" role="button" tabIndex="0" href="#">Spanish</a>
                    <a data-rr-ui-dropdown-item="" className="dropdown-item" role="button" tabIndex="0" href="#">Language</a>
                    <a data-rr-ui-dropdown-item="" className="dropdown-item" role="button" tabIndex="0" href="#">Language</a>
                    <a data-rr-ui-dropdown-item="" className="dropdown-item" role="button" tabIndex="0" href="#">Language</a>
                    <a data-rr-ui-dropdown-item="" className="dropdown-item" role="button" tabIndex="0" href="#">Language</a>
                    <a data-rr-ui-dropdown-item="" className="dropdown-item" role="button" tabIndex="0" href="#">Language</a>
